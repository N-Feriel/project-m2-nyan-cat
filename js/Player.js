...
class Player {
    ...
    // We do the same thing for the up key. See Engine.js to see when this happens.
    ...
    // We do the same thing for the down key. See Engine.js to see when this happens.
