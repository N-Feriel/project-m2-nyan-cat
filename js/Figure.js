...
class Figure {
    ...
    constructor(theRoot, spot, imgPath, height, width, MsgStr, speed) {
        ...
        this.domElement2 = document.createElement('h1');
        this.domElement2.style.color = 'white';
        this.domElement2.innerHTML = MsgStr;
        ...
        this.domElement2.style.left = `${this.x}px`;
        this.domElement2.style.top = `${this.y}px`;
        this.domElement2.style.zIndex = 10;

        // Show that the user can actually see the img DOM node, we append it to the root DOM node.
        theRoot.appendChild(this.domParent);
        this.domParent.appendChild(this.domElement);
        this.domParent.appendChild(this.domElement2);
    ...
    update(timeDiff) {
        ...
        if (this.y > GAME_HEIGHT) {
            this.root.removeChild(this.domParent);
